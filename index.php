    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round w3-white">
        <div class="w3-container">
         ...
         <hr>
         <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> <?php echo $_SESSION['proffession'];?></p>
         <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> <?php echo $_SESSION['address'];?></p>
         <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> <?php echo $_SESSION['date_of_birth'];?></p>
        </div>
      </div>
      <br>
        ...
        <div class="w3-container">
          ...
          <p>
            <?php
              ...
              $temp = explode(",",$_SESSION['interests']);
              $count = count($temp);
              $count--;
              for($i=0; $i<$count; $i++)
              {
        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <p id="user_status" contenteditable="true" class="w3-border w3-padding">Type here...</p>
              <button id="update_status" type="button" class="w3-button w3-theme"><i class="fa fa-pencil"></i>  Post</button>
            </div>
          </div>
        </div>
      </div>
